...
KOReader 官方不提供 rpm 包，本仓库用官方 Linux x86_64 自包含 tarball 封装成 Fedora 可用的 rpm（只做打包，不改代码）。

> English version: [README.md](README.md)

## 上游项目

- [KOReader](https://github.com/koreader/koreader) — 原始电子书阅读器项目（AGPL-3.0）
- 本仓库仅封装官方发布的二进制，一切归功于 KOReader 团队。
...
成品 rpm 也发布在 [Releases 页面](https://github.com/Sciolus-nut/koreader-rpm/releases)。
